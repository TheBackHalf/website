...
export async function GET(request: Request) {
  ...
  const printUrl = `${origin}/blueprint/print/artifacts/architect-identity-statement?architectId=${encodeURIComponent(actor.user.id)}`;
    ...
    try {
      ...
      return new NextResponse(Buffer.from(pdf), {
        ...
        headers: {
          ...
          "Content-Disposition":
            'attachment; filename="back-half-architect-identity-statement.pdf"',
