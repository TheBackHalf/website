...
export async function GET(request: Request) {
  ...
  const printUrl = `${origin}/blueprint/print/artifacts/back-half-standards?architectId=${encodeURIComponent(actor.user.id)}`;
    ...
    try {
      ...
      return new NextResponse(Buffer.from(pdf), {
        ...
        headers: {
          ...
          "Content-Disposition":
            'attachment; filename="back-half-standards.pdf"',
