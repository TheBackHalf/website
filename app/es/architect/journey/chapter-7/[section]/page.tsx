...
export default async function EsArchitectChapter7SectionPage({
  params,
}: PageProps) {
  const { section } = await params;
  redirectIfLegacyTeachingRoute("es", 7, section);
  return (
    <Chapter7Page locale="es" sectionId={parseChapter7SectionParam(section)} />
  );
}
