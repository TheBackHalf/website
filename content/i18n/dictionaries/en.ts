...
export const enDictionary: Dictionary = {
  ...
  appShell: {
    ...
    lumina: {
      ...
      errorRateLimited: "Lumina is receiving many messages right now. Please wait a moment and try again.",
      errorQuota: "Lumina has reached today’s usage limit. Your Journey and account are unaffected. Please try again tomorrow.",
      errorDisabled: "Lumina conversation is temporarily unavailable. Your Journey and account are unaffected.",
      errorUnavailable: "Lumina could not complete a live reply just now. You can try again.",
