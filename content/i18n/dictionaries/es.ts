...
export const esDictionary: Dictionary = {
  ...
  appShell: {
    ...
    lumina: {
      ...
      errorRateLimited: "Lumina está recibiendo muchos mensajes ahora. Espera un momento e inténtalo de nuevo.",
      errorQuota: "Lumina alcanzó el límite de uso de hoy. Tu Journey y tu cuenta no se ven afectados. Inténtalo mañana.",
      errorDisabled: "La conversación con Lumina no está disponible temporalmente. Tu Journey y tu cuenta no se ven afectados.",
      errorUnavailable: "Lumina no pudo completar una respuesta en vivo ahora. Puedes intentarlo de nuevo.",
