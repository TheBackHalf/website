...
const CERTIFICATE_HREF = "/api/architect/blueprint/certificate";
...
export function CertificateDownload({
  ...
  async function download() {
    ...
    setPending(true);
    try {
      const response = await fetch(CERTIFICATE_HREF, {
        method: "GET",
      ...
      anchor.download = BLUEPRINT_EXPORT_FILES.certificate;
