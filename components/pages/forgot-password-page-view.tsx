...
export function ForgotPasswordPageView({
  ...
  return (
    <>
      <SkipLink href="#forgot-password-main">
...
export function createForgotPasswordMetadata(locale: Locale): Metadata {
  const meta = getDictionary(locale).metadata.forgotPassword;
