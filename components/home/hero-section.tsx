  ...
  return (
    ...
    <section id="hero" className="bh-hero px-5 text-center sm:px-6">
      ...
      <div className="bh-reveal relative z-10 mx-auto flex max-w-5xl flex-col items-center pt-20 md:pt-24">
        ...
        <p className="bh-hero-subtext relative mt-7 max-w-2xl text-lg leading-8 md:mt-10 md:max-w-4xl md:text-xl md:leading-9 xl:max-w-none xl:whitespace-nowrap xl:text-[clamp(1.05rem,1.45vw,1.5rem)] xl:leading-10 xl:tracking-[-0.015em]">
